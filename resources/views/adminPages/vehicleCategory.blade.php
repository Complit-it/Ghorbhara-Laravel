                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <!-- form start -->
                            @if ($selectSubCatId == null)
                            <form role="form" action="/vehicle-category" method="post" enctype="multipart/form-data">
                                @else
                                    <form role="form" action="/edit-vehicle-category" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="categoryId">Select Brand <span style="color:red">*</span></label>
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="exampleInputEmail1">Vehicle Category Name <span
                                    ...
                                    <tbody>
                                        ...
                                        @for ($i = 0; $i < count($allSubcategories); $i++)
                                            <tr>
                                                ...
                                                <td>{{ $allSubcategories[$i]->vehiclebrand->name }}</td>
...
<a href="{{ url($allSubcategories[$i]['image']) }}" target="_blank" >Preview</a>
                                                ...
                                                <td>
                                                <a href="/edit-vehicle-category/{{ $allSubcategories[$i]['id'] }}"
                                                        class="btn btn-primary btn-sm">Edit</a>
                                                    <a href="/delete-vehicle-category/{{ $allSubcategories[$i]['id'] }}"
