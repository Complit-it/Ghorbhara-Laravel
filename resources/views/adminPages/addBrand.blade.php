                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <!-- form start -->
                            @if ($selectCatId == null)
                                <form role="form" action="/vehicle-brand" method="post" enctype="multipart/form-data">
                                @else
                                    <form role="form" action="/edit-vehicle-brand" method="post"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="exampleInputEmail1">Vehicle Brand Name <span
                                    ...
                                    <div class="form-group">
                                        <label for="customFile">Select Brand Image</label>
                                        ...
                                        @foreach ($cities as $service)
                                            <tr>
                                                ...
                                                <td> <!-- HTML code to open image in modal -->
                                                    <a href="{{ url($service->image) }}"  target="_blank" >Preview</a>
                                                </td>
                                                <td>
                                                    <a href="/edit-vehicle-brand/{{ $service->id }}"
                                                        class="btn btn-primary btn-sm">Edit</a>
                                                    <a href="/delete-vehicle-brand/{{ $service->id }}"
